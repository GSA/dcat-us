...
#### <a name="restrictionStatus_oneOf_i0_@id"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > @id`
...
#### <a name="restrictionStatus_oneOf_i0_@type"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > @type`
...
#### <a name="restrictionStatus_oneOf_i0_altLabel"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > altLabel`
...
#### <a name="restrictionStatus_oneOf_i0_altLabelMap"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > altLabelMap`
...
#### <a name="restrictionStatus_oneOf_i0_definition"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > definition`
...
#### <a name="restrictionStatus_oneOf_i0_definitionMap"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > definitionMap`
...
#### <a name="restrictionStatus_oneOf_i0_inScheme"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme`
...
##### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_@id"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > @id`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_@type"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > @type`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_version"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > version`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_created"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > created`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_created_anyOf_i0"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > created > anyOf > item 0`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_created_anyOf_i1"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > created > anyOf > item 1`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_created_anyOf_i1_oneOf_i0"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > created > anyOf > item 1 > oneOf > item 0`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_created_anyOf_i1_oneOf_i1"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > created > anyOf > item 1 > oneOf > item 1`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_created_anyOf_i1_oneOf_i2"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > created > anyOf > item 1 > oneOf > item 2`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_created_anyOf_i1_oneOf_i3"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > created > anyOf > item 1 > oneOf > item 3`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_description"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > description`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_descriptionMap"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > descriptionMap`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_issued"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > issued`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_issued_anyOf_i0"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > issued > anyOf > item 0`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_issued_anyOf_i1"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > issued > anyOf > item 1`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_issued_anyOf_i1_oneOf_i0"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > issued > anyOf > item 1 > oneOf > item 0`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_issued_anyOf_i1_oneOf_i1"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > issued > anyOf > item 1 > oneOf > item 1`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_issued_anyOf_i1_oneOf_i2"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > issued > anyOf > item 1 > oneOf > item 2`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_issued_anyOf_i1_oneOf_i3"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > issued > anyOf > item 1 > oneOf > item 3`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_modified"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > modified`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_modified_anyOf_i0"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > modified > anyOf > item 0`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_modified_anyOf_i1"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > modified > anyOf > item 1`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_modified_anyOf_i1_oneOf_i0"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > modified > anyOf > item 1 > oneOf > item 0`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_modified_anyOf_i1_oneOf_i1"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > modified > anyOf > item 1 > oneOf > item 1`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_modified_anyOf_i1_oneOf_i2"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > modified > anyOf > item 1 > oneOf > item 2`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_modified_anyOf_i1_oneOf_i3"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > modified > anyOf > item 1 > oneOf > item 3`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_title"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > title`
...
###### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i0_titleMap"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > ConceptScheme > titleMap`
...
##### <a name="restrictionStatus_oneOf_i0_inScheme_oneOf_i1"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > inScheme > oneOf > item 1`
...
#### <a name="restrictionStatus_oneOf_i0_notation"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > notation`
...
##### <a name="restrictionStatus_oneOf_i0_notation_anyOf_i0"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > notation > anyOf > item 0`
...
##### <a name="restrictionStatus_oneOf_i0_notation_anyOf_i1"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > notation > anyOf > item 1`
...
###### <a name="restrictionStatus_oneOf_i0_notation_anyOf_i1_items"></a>UseRestriction > restrictionStatus > oneOf > Concept > notation > anyOf > item 1 > item 1 items
...
#### <a name="restrictionStatus_oneOf_i0_prefLabel"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > prefLabel`
...
#### <a name="restrictionStatus_oneOf_i0_prefLabelMap"></a>Property `UseRestriction > restrictionStatus > oneOf > Concept > prefLabelMap`
